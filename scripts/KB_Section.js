import { findMenuItem } from "./main.js";
...
document.getElementsByClassName("receipt4")[0].innerHTML = `<p id="waiter"><b>Kyle's Final Take</b></p>`;
...
const KB_tipAmount = KB_totalBill * 0.2;
const KB_finalAmount = KB_tipAmount.toFixed(2);

let KB_grandTotal = Number(KB_totalBill) + Number(KB_finalAmount);
KB_grandTotal = KB_grandTotal.toFixed(2);

document.getElementsByClassName("receipt4")[0].innerHTML = findMenuItem()
document.getElementsByClassName("tip4")[0].innerHTML 
= `<p id="waiter"><b>Kyle's Final Take</b></p> <p>Subtotal: $${KB_totalBill} <p>Total: $${KB_grandTotal}  <h3 id="waiter">Kyle's Tips: $${KB_tipAmount}`;
